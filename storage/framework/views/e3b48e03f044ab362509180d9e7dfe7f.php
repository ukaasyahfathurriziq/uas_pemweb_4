...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Kriteria -->
            <li class="nav-item <?php echo e(Nav::isRoute('kriteria.index')); ?>">
                <a class="nav-link" href="<?php echo e(route('kriteria.index')); ?>">
                    <i class="fas fa-fw fa-list-alt"></i>
                    <span><?php echo e(__('Kriteria')); ?></span>
                </a>
            </li>

            <li class="nav-item <?php echo e(Nav::isRoute('alternatif.index')); ?>">
                <a class="nav-link" href="<?php echo e(route('alternatif.index')); ?>">
                    <i class="fas fa-fw fa-list-alt"></i>
                    <span><?php echo e(__('Alternatif')); ?></span>
                </a>
            </li>

            <li class="nav-item <?php echo e(Nav::isRoute('penilaian.index')); ?>">
                <a class="nav-link" href="<?php echo e(route('penilaian.index')); ?>">
                    <i class="fas fa-fw fa-list-alt"></i>
                    <span><?php echo e(__('Penilaian')); ?></span>
                </a>
            </li>

            <!-- Add this to your navigation menu -->
            <li class="nav-item <?php echo e(Nav::isRoute('perhitungan.wp')); ?>">
                <a class="nav-link" href="<?php echo e(route('perhitungan.wp')); ?>">
                    <i class="fas fa-fw fa-calculator"></i>
                    <span><?php echo e(__('Perhitungan WP')); ?></span>
                </a>
            </li>
...
<?php /**PATH C:\Users\Alim Terrible\OneDrive\Gambar\DokumentasiLaravelSPK-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>